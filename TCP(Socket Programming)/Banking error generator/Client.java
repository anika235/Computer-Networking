                ...
                if(line3.equals("ok"))
                {
                    ...
                    do
                    {
                        ...
                        if(choose ==2) {
                            ...
                            traxid += 1;//send trax id
                            out.writeUTF("" + traxid);

                            line = in.readUTF();//got server id
                            serverid = new Integer(line);
                            System.out.println("Server id: "+serverid);
                            System.out.println("trax id:"+traxid);

                            String money = input.readLine();//money send
                            out.writeUTF(money);
                            ...
                            while(true)
                            {
                                ...
                                {
                                    int tmp = new Integer(line.substring(2,line.length()));
                                    //System.out.println(tmp);
                                    //System.out.println(traxid);
                                    if(tmp!=traxid)
                                    {
                                        out.writeUTF("mile nai");
                                    }
                                    else {
